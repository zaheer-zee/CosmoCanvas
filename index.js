// All NASA API calls go through our secure serverless proxy at /api/apod
// This keeps the NASA_API_KEY on the server and out of the browser
...
document.getElementById('btn').addEventListener('click', async () => {
    ...
    let url = `/api/apod?date=${selectedDate}`;
...
const loadGallery = async () => {
    let galleryUrl = `/api/apod?count=12`;
    try {
